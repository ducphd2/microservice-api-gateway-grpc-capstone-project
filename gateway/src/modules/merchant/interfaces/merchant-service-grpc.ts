...
import { CreateMerchantRequestInputDto } from '../dtos/merchant/create-merchant.dto';
...
export interface IDeleteMerchantPayload {
  errors?: ErrorPayload[];
  count?: number;
}

@ObjectType()
export class FindAllMerchants {
  @Field(() => [Merchant])
  merchants: Merchant[];
}
...
export interface IMerchantServiceGrpc {
  ...
  createMerchant(input: CreateMerchantRequestInputDto, metadata?: Metadata): Observable<Merchant>;
  find(query?: IQuery, metadata?: Metadata): Observable<FindAllMerchants>;
  findById(id: IId, metadata?: Metadata): Observable<Merchant>;
  findOne(query?: IQuery, metadata?: Metadata): Observable<Merchant>;
  count(query?: IQuery, metadata?: Metadata): Observable<ICount>;
  update(input: UpdateMerchantInput): Observable<Merchant>;
