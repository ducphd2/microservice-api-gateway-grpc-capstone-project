...
import { IBranchServiceGrpc, ICreateServiceInput } from '../../interfaces/services';
import { BranchService, BranchServiceConnection, UpdateBranchService } from '../../types';
...
export class BranchServicesService {
  ...
  async create(data: ICreateServiceInput): Promise<BranchService> {
