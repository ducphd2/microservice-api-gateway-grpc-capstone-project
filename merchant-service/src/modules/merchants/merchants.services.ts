...
import { BranchesService } from '../branches/branches.services';
import { MerchantsRepository } from './merchants.repository';

@Injectable()
export class MerchantsService {
  constructor(private merchantsRepository: MerchantsRepository, private merchantBranchesService: BranchesService) {}
